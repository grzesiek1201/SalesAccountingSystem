...
namespace AccountingSystem.AccountingSystem.UI
{
    internal class ProductUI
    {
        ...
        public void EditProductFlow()
        {
            ...
            switch (result)
            {
                case AccountingSystem.AccountingSystem.Domain.Enums.ProductEditResult.Success:
                    Console.WriteLine("Product updated successfully");
                    break;

                case AccountingSystem.AccountingSystem.Domain.Enums.ProductEditResult.NotFound:
                    Console.WriteLine("Product not found");
                    break;

                case AccountingSystem.AccountingSystem.Domain.Enums.ProductEditResult.ProductArchived:
                    Console.WriteLine("Product is archived");
                    break;

                case AccountingSystem.AccountingSystem.Domain.Enums.ProductEditResult.InvalidData:
        ...
        public void ArchiveProductFlow()
        {
            ...
            switch (result)
            {
                case AccountingSystem.AccountingSystem.Domain.Enums.ArchiveProductResult.NotFound:
                    Console.WriteLine("Product not found");
                    break;

                case AccountingSystem.AccountingSystem.Domain.Enums.ArchiveProductResult.Success:
