...
namespace AccountingSystem.AccountingSystem.UI
{
    internal class CustomerUI
    {
        ...
        public void EditCustomerFlow()
        {
            ...
            switch (result)
            {
                case AccountingSystem.AccountingSystem.Domain.Enums.CustomerEditResult.Success:
                    Console.WriteLine("Customer updated successfully");
                    break;

                case AccountingSystem.AccountingSystem.Domain.Enums.CustomerEditResult.NotFound:
                    Console.WriteLine("Customer not found");
                    break;

                case AccountingSystem.AccountingSystem.Domain.Enums.CustomerEditResult.CustomerArchived:
                    Console.WriteLine("Customer is archived");
                    break;

                case AccountingSystem.AccountingSystem.Domain.Enums.CustomerEditResult.InvalidData:
        ...
        public void ArchiveCustomerFlow()
        {
            ...
            switch (result)
            {
                case AccountingSystem.AccountingSystem.Domain.Enums.ArchiveCustomerResult.NotFound:
                    Console.WriteLine("Customer not found");
                    break;

                case AccountingSystem.AccountingSystem.Domain.Enums.ArchiveCustomerResult.CustomerInDebt:
                    Console.WriteLine("Customer has unpaid debt");
                    break;

                case AccountingSystem.AccountingSystem.Domain.Enums.ArchiveCustomerResult.Success:
